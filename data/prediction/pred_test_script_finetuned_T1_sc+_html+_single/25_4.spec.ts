...
test('test', async ({ page }) => {
  ...
  await page.getByLabel('Name der Arbeitsmappe').setValue('Testmappe_Ladesaeulen.zip');
  await page.getByLabel('Name der Arbeitsmappe').press('Enter');
  await page.getByLabel('Bitte wählen Sie eine Datei').setInputFiles('Testmappe_Ladesaeulen.zip');
  await page.getByLabel('Bitte wählen Sie eine Datei').press('Enter');
  await page.getByLabel('Bitte wählen Sie eine Datei').setInputFiles('Testmappe_Ladesaeulen.zip');
  await page.getByLabel('Bitte wählen Sie eine Datei').press('Enter');
  await page.getByLabel('Bitte wählen Sie eine Datei').setInputFiles('Testmappe_Ladesaeulen.zip');
  await page.getByLabel('Bitte wählen Sie eine Datei').press('Enter');
  await page.getByLabel('Bitte w