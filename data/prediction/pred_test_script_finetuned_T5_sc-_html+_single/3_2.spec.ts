...
test('test', async ({ page }) => {
  ...
  await page.getByRole('menuitem', { name: 'Arbeitsmappe Arbeitsmappen' }).click();
  await page.getByRole('menuitem', { name: 'Arbeitsmappe Arbeitsmappen' }).getByLabel('Mehr … (A)').click();
  await page.getByRole('menuitem', { name: 'Arbeitsmappe Arbeitsmappen' }).getByLabel('Mehr … (A)').click();
  await page.getByRole('menuitem', { name: 'Arbeitsmappe Arbeitsmappen' }).getByLabel('Mehr … (A)').click();
  await page.getByRole('menuitem', { name: 'Arbeitsmappe Arbeitsmappen' }).getByLabel('Mehr … (A)').click();
  await page.getByRole('menuitem', { name: 'Arbeitsmappe Arbeitsmappen' }).getByLabel('Mehr … (A)').click();
