...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Automobile' }).click();
  await page.getByRole('option', { name: 'Repository Ladesaeulen' }).click();
  await page.getByRole('menuitem', { name: 'Importieren' }).click();
});