...
// Add code to the precondition to click on the "Bericht (*.pdf)..." link
await page.getByText('Bericht (*.pdf) ...', { exact: true }).click();

// Add code to the precondition to take a screenshot of the page
