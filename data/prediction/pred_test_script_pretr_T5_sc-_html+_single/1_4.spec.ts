...
await page.getByTestId('worksheet-view-of-type-table').click();
await page.getByTestId('worksheet-view-of-type-table').fill('Admin');
await page.getByTestId('worksheet-view-of-type-table').press('Enter');
